...
<div class="page-container">
  ...
  password not equal repassword, try again!
</div>';
                      return ;
                }

                $r = $conn->query("UPDATE `users` SET `password`='$password' WHERE `email`='$email'");
  ...
  Error!
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input type="TXT" name="repassword" class="form-control" id="exampleFormControlInput1"
                       placeholder="">
            </div>
            <button name="create">update</button>
        </form>
