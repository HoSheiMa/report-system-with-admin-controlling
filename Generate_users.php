...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <form method="post" action="./Generate_users_script.php">



            <div class="form-group">
                <label for="exampleFormControlSelect1">
                    <b><font size="3" style="color:#253A8F">Number of emails</font></b></label>
                <select id="number" class="form-control" name="number" id="exampleFormControlSelect1"
                        required>
                    <option id="placeHolder" disabled selected>Select number</option>
            ...
            <div class="form-group">
                <label for="exampleFormControlSelect1" style="color:#253A8F"><b><font size="3" style="color:#253A8F">permission </font></b></label>
            ...
            <button name="create" class="btn btn-success"><b>GENERATE EMAILS</b></button>
        </form>
