  ...
  success
    ...
    display: inline-block' method='post'>      
                          ...
                          <button type='submit' name='delete' class='btn btn-danger'>Delete</button> </form>
                                  <button class='btn btn-info' onclick='edit(\"{$item['id']}\", \"{$item['email']}\", \"{$item['username']}\", \"{$item['role']}\")'>Edit</button>  
    ...
    <script>
        ...
        edit = (id, email, username, permission) => {
            ...
            $.confirm({
                ...
                content: '' +
                    '<form action="./update_user_info.php" method="post" class="formName">' +
                    `<input name="id" type="hidden" value="${id}">` +
                    '<div class="form-group">' +
                    '<label>Email</label> <br>' +
                    `<input type="text"  class="form-control"  name="email" value="${email}"> <br> <br>` +
                    '<label>Username</label> <br>' +
                    `<input type="text"  class="form-control"  name="username" value="${username}"> <br><br>` +
                    '<label>Password</label> <br>' +
                    `<input  class="form-control"  type="text" name="password" value=""> <br><br>` +
                    '<label>Permission</label> <br>' +
                    `<div class="form-group">
                        <select class="form-control" name="permission" id="exampleFormControlSelect1">
                            <option ${permission === "Basic User" ? "selected" : ""}>Basic User</option>
                            <option ${permission === "Pro User" ? "selected" : ""}>Pro User</option>
                            <option ${permission === "Agency User" ? "selected" : ""}>Agency User</option>
                            <option ${permission === "admin" ? "selected" : ""}>admin</option>
                        </select>
                    </div>`+
